...
export default function FarmerDashboard() {
  ...
  const stats = [
    ...
    { label: "Groundnut Price", value: "₹5,200", subtext: "Per Quintal", icon: <IndianRupee className="text-blue-500" size={24} />, bg: "bg-blue-50" },
  ...
  const actions = [
    { label: "Disease Check", icon: <Camera size={22} className="text-red-600" />, path: "/dashboard/farmer/disease-check", bg: "bg-red-50", border: "border-red-100" },
    { label: "Marketplace", icon: <ShoppingCart size={22} className="text-emerald-600" />, path: "/dashboard/farmer/marketplace", bg: "bg-emerald-50", border: "border-emerald-100" },
    { label: "Rent Machine", icon: <Tractor size={22} className="text-orange-600" />, path: "/dashboard/farmer/rent-machine", bg: "bg-orange-50", border: "border-orange-100" },
  ];
      ...
      <div className="bg-green-50 rounded-xl p-5 border border-green-100 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-green-700 text-sm mt-1">
            இன்று மழை வாய்ப்பு உள்ளது — pesticide spray வேண்டாம். Groundnut rate ₹5,200 — விற்பதற்கு நல்ல நேரம்.
          </p>
        </div>
      </div>
